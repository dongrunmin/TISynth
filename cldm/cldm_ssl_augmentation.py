...
from ldm.modules.diffusionmodules.openaimodel_ssl import UNetModel, TimestepEmbedSequential, ResBlock, Downsample, AttentionBlock
from ldm.models.diffusion.ddpm_ref_augmentation import LatentDiffusion
from ldm.util import log_txt_as_img, exists, instantiate_from_config
from ldm.models.diffusion.ddim_ref import DDIMSampler
    ...
    def forward(self, x, timesteps=None, context=None, control=None, ssl_latent=None, **kwargs):
        ...
        with torch.no_grad():
            ...
            for module in self.input_blocks:
                ...
                hs.append(h)
            h = self.middle_block(h, emb, context, ssl_latent)
        ...
        for i, module in enumerate(self.output_blocks):
            ...
            h = module(h, emb, context, ssl_latent)
