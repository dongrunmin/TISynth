...
class AugmentPipe:
    def __init__(self, p=0.12,
        translate_int=1, translate_int_max=0.125,
        scale=1, rotate_frac=1, aniso=0, translate_frac=1, scale_std=0.2, rotate_frac_max=0.1, aniso_std=0, aniso_rotate_prob=0, translate_frac_std=0.125,
        cutout=0, 
    ):
        super().__init__()
